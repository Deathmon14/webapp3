  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage bookings, assign vendors, and track event progress</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            ...
            }) : <p className="text-gray-500 text-center py-8">No bookings found. Try creating one from a client account.</p>}
          </div>
        </div>
                    ...
                    return (
                      <div key={category} className="border border-gray-200 rounded-xl p-4">
                        ...
                        {assignedTask ? (<p className="text-sm text-gray-600">{assignedTask.vendorName}</p>) : (
                          <select onChange={(e) => assignVendor(selectedBooking, e.target.value, category)} className="w-full mt-2 px-3 py-2 border border-gray-300 rounded-lg text-sm" defaultValue="">
